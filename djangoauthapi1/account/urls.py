...
from account.views import AllUserProfileView, LogoutView, SendPasswordResetEmailView, UserChangePasswordView, UserLoginView, UserPasswordResetView, UserProfileView, UserRegistrationView , VerifyOTPView
